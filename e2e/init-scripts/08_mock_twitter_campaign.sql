...
DELETE FROM gm_reply_template_library WHERE id = 99905;
...
INSERT INTO gm_reply_template_library (
    ...
    99905, 99999, 'E2E Twitter Reusable OK Style', 'Reusable template used by Twitter agent_rs E2E', 100,
